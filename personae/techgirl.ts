...
export const techgirl: PersonaConfig = {
	id: "techgirl",
	size: 1000,
	posXRange: 0.6,
	posXOffset: 0.2,
...
The topic must at least vaguely fit with my personality: I am a female tech enthusiast in my late 20s from the USA. I like discussing about and reviewing the latest tech products, trends, and gadgets.
...
3. Arc: 
   ...
   - Vibe: Prioritize character voice and emotion over dry facts.`;
	...
	stances: ["talking", "blushing", "thinking", "angry"],
};
